...
{
    const ENV = "sandbox";
    const EMAIL = "felip.bertoli@gmail.com";
    const TOKEN_PRODUCTION = "your_production_token";
    const TOKEN_SANDBOX = "5D1769F10F9B4785B0B6EAAB8F4DC82D";
    const APP_ID_PRODUCTION = "your_production_application_id";
    const APP_ID_SANDBOX = "app6391146918";
    const APP_KEY_PRODUCTION = "your_production_application_key";
    const APP_KEY_SANDBOX = "43427617DADA29EFF46CDF9B84AC9C4C";
    const CHARSET = "UTF-8";
